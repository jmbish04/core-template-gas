/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.generated.jsonc` (hash: d4b5448ceb3ee32b5d940e2ddfb31d5f)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	R2_RESEARCH_PWAS: R2Bucket;
	R2_FILES_BUCKET: R2Bucket;
	DB: D1Database;
	VECTORIZE_RESEARCH_ARCHIVE: VectorizeIndex;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INBOX_FORWARD_TO" | "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "MODEL_TRANSCRIBE" | "DEFAULT_MODEL_EMBEDDING">> {}
}
